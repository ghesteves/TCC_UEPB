\documentclass[article,12pt,oneside,a4paper,chapter=TITLE,english,brazil]{abntex2}
...
\tituloestrangeiro{Work title: subtitle} % Title (outro idioma - opcional)
...
% Coloque o coorientador apenas se tiver

% Centro e departamento não são obrigatórios
\campus{Campus I}
...
%%-----------------------------------------------------------------------
%% Inserir a ficha bibliografica (depois de feita pela Biblioteca e salva em PDF). Descomentar as 4 linhas abaixo.
...
\membroum[Prof.]{Primeiro Membro (Orientador) \\ Universidade Estadual da Paraíba (UEPB)}
\membrodois[Prof.]{Segundo Membro \\ Universidade Estadual da Paraíba (UEPB)}
\membrotres[Profa.]{Terceiro Membro \\ Universidade Estadual da Paraíba (UEPB)}
\datadefesa{DIA de MÊS de ANO}
\folhadeaprovacaoUEPB

%%-----------------------------------------------------------------------       IMPORTANTE!!
 
% Após a defesa, substitua todo o conteúdo das 5 linhas acima por uma
% imagem digitalizada da página assinada pela banca com o comando abaixo:
%
...
\end{center}
% O título em língua estrangeira é OPCIONAL.
...
%
% Tudo o que vem a partir daqui é opcional e só deve ficar se for usado no 
% trabalho.
%------------------------------------------------------------------------
...
% Apêndices
% 
% Os Apêndices devem usados para inserir algum texto de produção SUA, que não seja
% essencial para o trabalho principal, mas cuja inclusão seja interessante.
...
% Anexos
% 
% Os Anexos têm a mesma funcionalidade dos Apêndices, mas para a inclusão de algum texto que NÃO seja de SUA  autoria.
